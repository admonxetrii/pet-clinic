                ...
                <g:each in="${this.owner.pets}" var="pet">
                    <tr>
                        ...
                        <td>
                            ...
                            <g:link controller="pet" action="edit" id="${pet.id}" params="[ownerId: this.owner.id]" class="btn btn-sm btn-warning">
...
<script>
    $(document).on("click", ".openDeletePetModal", function () {
        ...
        const uri = '${createLink(uri:'/pet/delete/')}' + petId + '?petId=' + petId;
