                ...
                <g:each in="${pet.visits}" var="visit">
                    <tr>
                        ...
                        <td>
                            ...
                            <g:link controller="visit" action="edit" id="${visit.id}" params="[petId: pet.id]" class="btn btn-sm btn-warning">
...
<div class="mt-4">
    <g:link controller="pet" action="edit" id="${pet.id}" params="[fromShow: true]" class="btn btn-primary">
