    ...
    <div class="card-body">
        ...
        <g:form controller="pet" action="save">
            ...
            <div class="row gx-3 mb-3">
                ...
                <div class="col-md-6 ${params.ownerId != null ? 'd-none' : ''}">
                    <label class="small mb-1" for="inputPetOwner">Owner</label>
                    <g:select id="inputPetOwner" name="owner.id" from="${owners}" optionKey="id" optionValue="${(owner) -> "${owner.firstName} ${owner.lastName}"}" value="${params.ownerId ?: pet?.owner?.id}" required="" class="form-control"/>
                </div>
