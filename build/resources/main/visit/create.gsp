        ...
        <g:form controller="visit" action="save">
            <div class="row gx-3 mb-3">
                <div class="col-md-6 ${params?.petId != null ? 'd-none' : ''}">
                    ...
                    <g:select id="inputVisitPet" name="pet.id" from="${pets}" optionKey="id" optionValue="${(pet) -> "${pet.name} (${pet.type})"}" value="${params?.petId ?: visit?.pet?.id}" required="" class="form-control"/>
                </div>
